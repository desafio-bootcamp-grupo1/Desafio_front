...
export default function FeaturesSection() {
  const items = [
    { Icon: Fuel, title: "Escaneo OCR", description: "Digitaliza automáticamente tickets de combustible y registra gastos con precisión usando tecnología OCR avanzada" },
